...
namespace pert12 {
  partial class DaftarBuku {
    ...
    private void InitializeComponent() {
      ...
      this.buku_ubdDataSet = new pert12.buku_ubdDataSet();
      this.bukuBindingSource = new System.Windows.Forms.BindingSource(this.components);
      this.bukuTableAdapter = new pert12.buku_ubdDataSetTableAdapters.BukuTableAdapter();
      this.tableAdapterManager = new pert12.buku_ubdDataSetTableAdapters.TableAdapterManager();
      ...
      this.tableAdapterManager.UpdateOrder = pert12.buku_ubdDataSetTableAdapters.TableAdapterManager.UpdateOrderOption.InsertUpdateDelete;
      // 
      // bukuDataGridView
      // 
